...
class ImportExtended(models.TransientModel):
    ...
    def _format_record_for_response(self, record, field_name):
        """Helper method to create consistent entity dictionaries"""
    ...
    def _transform_data_if_needed(self, rows, options):
    ...
    def parse_preview(self, options, count=10):
        ...
        try:
            ...
            # Apply transformation if transformer is selected
            rows, options = self._transform_data_if_needed(rows, options)
    ...
    def _convert_import_data(self, fields, options):
        ...
        if self.transformer_id:
            ...
            # Transform the data
            transformed_rows, options = self._transform_data_if_needed(rows_to_import, options)
