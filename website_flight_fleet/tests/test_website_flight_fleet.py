...
class TestWebsiteFlightFleet(TransactionCase):
    ...
    def test_05_aircraft_image_management(self):
        ...
        import base64
        test_image_data = base64.b64encode(b'fake_image_data_for_testing').decode('utf-8')
    ...
    def test_11_aircraft_model_codes(self):
        ...
        codes = [self.model_g650.code, self.model_citation.code, 
                self.model_caravan.code, self.model_bell407.code]
