odoo.define(
  "website_flight_fleet.dynamic_aircraft_images_options",
  function (require) {
    const options = require("web_editor.snippets.options");
    const s_dynamic_snippet_carousel_options = require("website.s_dynamic_snippet_carousel_options");

    const dynamicSnippetAircraftImagesOptions =
      s_dynamic_snippet_carousel_options.extend({
        init() {
        ...
        onBuilt() {
          ...
          this.$target[0].dataset.snippet =
            "s_website_flight_fleet_dynamic_aircraft_images";
        },
    ...
    options.registry.dynamic_snippet_aircraft_images =
      dynamicSnippetAircraftImagesOptions;
